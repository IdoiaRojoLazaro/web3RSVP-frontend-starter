              ...
              event.eventOwner.toLowerCase() ? (
                <section>
                  <Link href="/my-events/past">
                    <a className="text-antiqueBlue-800 text-sm hover:underline">
                      &#8592; Back
                    </a>
                  </Link>
                          ...
                          <table className="min-w-full divide-y divide-gray-300">
                            <thead className="bg-gray-50">
                              <tr>
                                ...
                                >
                                  {event.confirmedAttendees === event.rsvps ? (
                                    <button
                                      type="button"
                                      className="items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-antiqueBlue-700 bg-antiqueBlue-100 hover:bg-antiqueBlue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-antiqueBlue-500"
                                ...
                                <tr key={rsvp.attendee.id}>
                                  ...
                                  <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    {checkIfConfirmed(
                                      ...
                                      <button
                                        type="button"
                                        className="text-antiqueBlue-600 hover:text-antiqueBlue-900"
                                        onClick={() =>
